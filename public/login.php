...
<title>Dorm Access System - Login</title>
...
<div class="login-card">
    <div class="text-center mb-4">
        ...
        <h2 class="fw-bold mb-1">Dorm Access System</h2>
        <p class="text-muted mb-0">Database Management Portal</p>
    </div>
